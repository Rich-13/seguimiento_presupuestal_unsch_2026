...
tab_titles = [
    ...
    "CUADRO DE NECESIDADES 2026",
    "REGISTRO DE SEGUIMIENTO 2026"
]
...
with tabs[0]:
    ...
    if agg_dict:
        ...
        st.markdown("**TABLA 01: EJECUCIÓN PRESUPUESTAL POR MES, 2026**")
...
with tabs[1]:
    ...
    st.markdown("**TABLA 02: CUADRO DE NECESIDADES POR MES, 2026**")
    AgGrid(
        df_datos_grupos,
...
with tabs[2]:
    ...
    st.link_button("IR AL APLICATIVO CEPLAN", "http://app.ceplan.gob.pe/POI2026/ingresar.aspx")
